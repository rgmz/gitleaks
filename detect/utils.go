...
func augmentGitFinding(scmPlatform scm.Platform, remoteUrl string, finding report.Finding, f *gitdiff.File, textFragment *gitdiff.TextFragment) report.Finding {
